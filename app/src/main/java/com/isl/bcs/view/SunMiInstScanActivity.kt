...
class SunMiInstScanActivity : BaseActivity(), SurfaceHolder.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sunmi_inst_scan)
        isImmersive = false
    ...
    override fun surfaceCreated(holder: SurfaceHolder) {
        try {
            verifyStoragePermissions(this@SunMiInstScanActivity)
        } catch (e: Exception) {
            mCamera = null
        }
    }
