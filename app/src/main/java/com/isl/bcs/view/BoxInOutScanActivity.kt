...
class BoxInOutScanActivity : BaseActivity() {
     ...
     * 扫描处理
     */
    private var mHandler: BoxInOutScanActivity.CaptureActivityHandler? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(mBinding) {
            ...
            //扫描动画初始化
            //初始化 CameraManager
            CameraManager.init(this@BoxInOutScanActivity)
            hasSurface = false
                ...
                if (instData[0].startsWith("O")) {
                    ...
                    if (result.isNotEmpty()) {
                        if (result[0].SCAN_QTY >= result[0].PKG_QTY) {
                            RxDialogSure(this@BoxInOutScanActivity).apply {
