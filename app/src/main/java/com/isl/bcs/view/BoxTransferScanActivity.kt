...
class BoxTransferScanActivity : BaseActivity() {
     ...
     * 扫描处理
     */
    private var mHandler: BoxTransferScanActivity.CaptureActivityHandler? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(mBinding) {
            ...
            //扫描动画初始化
            //初始化 CameraManager
            CameraManager.init(this@BoxTransferScanActivity)
            hasSurface = false
    ...
    fun handleDecode(result: Result) {
        ...
        if (boxInRes.isNotEmpty()) {
            openActivity<BoxTransferPreviewActivity>(
